...
```abnf
c4m-stream  = *( line LF )
line        = entry-line / bare-c4id / blank-line
blank-line  = *SP
bare-c4id   = c4-id
...
(specified in full in [design/filename-encoding.md](../design/filename-encoding.md))
...
- **C4 ID**: Computed from the canonical form of expanded members (same
  algorithm as directory C4 IDs)
