...
// LoadBundleAsManifestV2 loads a bundle following the proper @base chain workflow
func LoadBundleAsManifestV2(bundlePath string) (*Manifest, error) {
...
// ExtractBundlePrettyV2 extracts a bundle using the new V2 algorithm
func ExtractBundlePrettyV2(bundlePath string, output io.Writer) error {
	manifest, err := LoadBundleAsManifestV2(bundlePath)
	if err != nil {
		return err
	}
...
// ExtractBundlePrettyToFileV2 extracts a bundle to a file using V2 algorithm
func ExtractBundlePrettyToFileV2(bundlePath, outputPath string) error {
	...
	return ExtractBundlePrettyV2(bundlePath, file)
}